...
export function toContainAllKeys<E = unknown>(actual: unknown, expected: readonly (keyof E | string)[]) {
  ...
  if (typeof actual === 'object' && actual !== null && !Array.isArray(actual)) {
    ...
    pass =
      ...
      expected.every(key => contains((a, b) => this.equals(a, b, this.customTesters), objectKeys as string[], key));
  }

  return {
    pass,
    message: () => {
      const received = objectKeys || Object.keys(actual as Record<string, unknown>);
      return pass
